...
class Grille:
    ...
    def  __init__(self) -> None:
        ...
        comme clefs
        On comptabilise aussi le nombre des voyageurs sortis de la grille
        Enfin, les attributs sommePas et sommeTemps comptabilisent la somme des
        pas effectués et la somme des trames passées dans la grille par les 
        Voyageurs lors de leur transfert
        """
        self.voyageurs = dict()
        self.obstacles = dict()
        self.portes = dict()
        self.nbVoyageursSortis = 0
        self.sommePas = 0
        self.sommeTemps = 0
...
#         return ((sx / size) - vx, (sy / size) - vy)
    ...
    def deleteVoyageur(self, v):
        ...
        self.nbVoyageursSortis += 1
        self.sommePas+= v.podometre
        self.sommeTemps += v.temps
    ...
    def deplacements(self):
        ...
        random.shuffle(voys) # pour introduire un peu d'aléatoire
        for v in voys:
            v.seDeplacer()
